...
def company_datasets():
    try:
        ...
        # Real public datasets used by/for these companies
        datasets_db = {
            'google': {
                'name': 'Google',
                'datasets': [
                    {'name':'Google Play Store Apps','url':'https://www.kaggle.com/datasets/lava18/google-play-store-apps','desc':'2M+ app ratings, reviews, categories','skills':'EDA, NLP, Classification','difficulty':'Beginner'},
                    {'name':'YouTube Statistics','url':'https://www.kaggle.com/datasets/datasnaek/youtube-new','desc':'Trending videos across countries','skills':'Time Series, NLP, Visualization','difficulty':'Intermediate'},
                    {'name':'Google Stock Price','url':'https://www.kaggle.com/datasets/shreenidhihipparagi/google-stock-prediction','desc':'Historical GOOGL stock data','skills':'Time Series, LSTM, Forecasting','difficulty':'Intermediate'},
                    {'name':'Google Landmark Recognition','url':'https://www.kaggle.com/competitions/landmark-recognition-2021','desc':'Image classification challenge','skills':'CNN, Transfer Learning, CV','difficulty':'Advanced'},
                    {'name':'BigQuery Public Datasets','url':'https://cloud.google.com/bigquery/public-data','desc':'Wikipedia, GitHub, Stack Overflow data','skills':'SQL, BigQuery, EDA','difficulty':'Intermediate'},
                ]
            },
            'microsoft': {
                'name': 'Microsoft',
                'datasets': [
                    {'name':'Microsoft Malware Detection','url':'https://www.kaggle.com/competitions/malware-classification','desc':'PE file malware classification','skills':'Feature Engineering, XGBoost, Random Forest','difficulty':'Advanced'},
                    {'name':'Azure ML Sample Datasets','url':'https://learn.microsoft.com/en-us/azure/open-datasets','desc':'NYC Taxi, Weather, Covid data','skills':'Azure ML, Pandas, ML Pipeline','difficulty':'Intermediate'},
                    {'name':'Microsoft Research Open Data','url':'https://msropendata.com','desc':'NLP, CV, healthcare datasets','skills':'NLP, Deep Learning, Research','difficulty':'Advanced'},
                    {'name':'GitHub Archive','url':'https://www.gharchive.org','desc':'GitHub events — code, commits, PRs','skills':'Graph Analysis, NLP, EDA','difficulty':'Intermediate'},
                    {'name':'Stack Overflow Survey','url':'https://insights.stackoverflow.com/survey','desc':'Developer survey 90K+ responses','skills':'EDA, Visualization, Statistics','difficulty':'Beginner'},
                ]
            },
            'amazon': {
                'name': 'Amazon',
                'datasets': [
                    {'name':'Amazon Product Reviews','url':'https://www.kaggle.com/datasets/arhamrumi/amazon-product-reviews','desc':'5M+ product reviews with ratings','skills':'NLP, Sentiment Analysis, Recommendation','difficulty':'Intermediate'},
                    {'name':'Amazon Sales Dataset','url':'https://www.kaggle.com/datasets/karkavelrajaj/amazon-sales-dataset','desc':'Product prices, ratings, categories','skills':'EDA, Price Prediction, Clustering','difficulty':'Beginner'},
                    {'name':'AWS Fraud Detection','url':'https://registry.opendata.aws/fraud-detection','desc':'Synthetic financial fraud data','skills':'Anomaly Detection, Imbalanced ML','difficulty':'Intermediate'},
                    {'name':'Amazon Movie Reviews','url':'https://huggingface.co/datasets/amazon_reviews_multi','desc':'Multilingual reviews including Hindi','skills':'Multilingual NLP, BERT','difficulty':'Advanced'},
                ]
            },
            'ibm': {
                'name': 'IBM',
                'datasets': [
                    {'name':'IBM HR Analytics (Attrition)','url':'https://www.kaggle.com/datasets/pavansubhasht/ibm-hr-analytics-attrition-dataset','desc':'Employee attrition prediction','skills':'Classification, HR Analytics, EDA','difficulty':'Beginner'},
                    {'name':'IBM Telco Customer Churn','url':'https://www.kaggle.com/datasets/blastchar/telco-customer-churn','desc':'7K customers, churn prediction','skills':'Classification, Feature Engineering','difficulty':'Beginner'},
                    {'name':'IBM Watson NLP Datasets','url':'https://dataplatform.cloud.ibm.com/exchange','desc':'NLP, image, structured data','skills':'AutoAI, Watson Studio, NLP','difficulty':'Intermediate'},
                ]
            },
            'flipkart': {
                'name': 'Flipkart',
                'datasets': [
                    {'name':'Flipkart Products','url':'https://www.kaggle.com/datasets/PromptCloudHQ/flipkart-products','desc':'20K products with descriptions, prices','skills':'NLP, Price Prediction, EDA','difficulty':'Beginner'},
                    {'name':'Flipkart Reviews','url':'https://www.kaggle.com/datasets/niraliivaghani/flipkart-product-customer-reviews-dataset','desc':'Customer reviews for sentiment','skills':'NLP, Sentiment, BERT','difficulty':'Intermediate'},
                ]
            },
            'swiggy_zomato': {
                'name': 'Swiggy/Zomato',
                'datasets': [
                    {'name':'Zomato Restaurants India','url':'https://www.kaggle.com/datasets/shrutimehta/zomato-restaurants-data','desc':'Restaurant data India, ratings, cuisines','skills':'EDA, Geo Analysis, Clustering','difficulty':'Beginner'},
                    {'name':'Swiggy Food Dataset','url':'https://www.kaggle.com/datasets/anuragbanerjee/food-ordering-and-delivery-dataset','desc':'Delivery time, ratings, food types','skills':'Regression, EDA, Feature Eng','difficulty':'Beginner'},
                    {'name':'Food Delivery Time Prediction','url':'https://www.kaggle.com/datasets/gauravmalik26/food-delivery-dataset','desc':'Delivery partner data, ETA prediction','skills':'Regression, Maps API, ML','difficulty':'Intermediate'},
                ]
            },
            'healthcare': {
                'name': 'Healthcare (Apollo/AIIMS/Fortis)',
                'datasets': [
                    {'name':'Heart Disease UCI Dataset','url':'https://www.kaggle.com/datasets/ronitf/heart-disease-uci','desc':'303 patients, 14 features, heart disease prediction','skills':'Classification, EDA, Feature Engineering','difficulty':'Beginner'},
                    {'name':'Diabetes Dataset (Pima Indians)','url':'https://www.kaggle.com/datasets/uciml/pima-indians-diabetes-database','desc':'768 patients, diabetes prediction','skills':'Classification, Logistic Regression, SVM','difficulty':'Beginner'},
                    {'name':'Breast Cancer Wisconsin','url':'https://www.kaggle.com/datasets/uciml/breast-cancer-wisconsin-data','desc':'569 tumors, malignant vs benign','skills':'Classification, PCA, Random Forest','difficulty':'Beginner'},
                    {'name':'COVID-19 India Dataset','url':'https://www.kaggle.com/datasets/sudalairajkumar/covid19-in-india','desc':'State-wise India COVID data','skills':'Time Series, Forecasting, Geo Viz','difficulty':'Intermediate'},
                    {'name':'Hospital Readmission','url':'https://www.kaggle.com/datasets/brandao/diabetes','desc':'130 hospitals, 10 years data, readmission prediction','skills':'Classification, Healthcare ML, Imbalanced Data','difficulty':'Intermediate'},
                    {'name':'Medical Cost Personal Dataset','url':'https://www.kaggle.com/datasets/mirichoi0218/insurance','desc':'Insurance charges prediction','skills':'Regression, EDA, Feature Engineering','difficulty':'Beginner'},
                    {'name':'Chest X-Ray Pneumonia','url':'https://www.kaggle.com/datasets/paultimothymooney/chest-xray-pneumonia','desc':'5000+ X-ray images, pneumonia detection','skills':'CNN, Transfer Learning, Medical Imaging','difficulty':'Intermediate'},
                    {'name':'Patient Survival Prediction','url':'https://www.kaggle.com/datasets/mitishaagarwal/patient','desc':'ICU patient survival, 91 features','skills':'Classification, Missing Values, Clinical ML','difficulty':'Advanced'},
                ]
            },
            'pharma': {
                'name': 'Pharma & Health Apps (Practo/1mg/PharmEasy)',
                'datasets': [
                    {'name':'Drug Reviews Dataset','url':'https://www.kaggle.com/datasets/jessicali9530/kuc-hackathon-winter-2018','desc':'Drug reviews + ratings + conditions','skills':'NLP, Sentiment Analysis, Rating Prediction','difficulty':'Intermediate'},
                    {'name':'Medicine Recommendation System','url':'https://www.kaggle.com/datasets/noorsaeed/medicine-recommendation-system-dataset','desc':'Symptoms to disease to medicine mapping','skills':'Recommendation, NLP, Classification','difficulty':'Intermediate'},
                    {'name':'Pharma Sales Data','url':'https://www.kaggle.com/datasets/milanzdravkovic/pharma-sales-data','desc':'6 years pharma sales time series','skills':'Time Series, ARIMA, Forecasting','difficulty':'Intermediate'},
                    {'name':'Healthcare Providers Data','url':'https://www.kaggle.com/datasets/tamilsel/healthcare-providers-data','desc':'Doctor specializations, locations, ratings','skills':'EDA, Clustering, Geo Analysis','difficulty':'Beginner'},
                    {'name':'Mental Health in Tech Survey','url':'https://www.kaggle.com/datasets/osmi/mental-health-in-tech-survey','desc':'Mental health workplace survey','skills':'EDA, Classification, Survey Analysis','difficulty':'Beginner'},
                    {'name':'Clinical Trials Dataset','url':'https://www.kaggle.com/datasets/arashnic/the-cancer-genome-atlas','desc':'Cancer genomics, multi-omics data','skills':'Bioinformatics, Deep Learning, Clustering','difficulty':'Advanced'},
                ]
            },
        }
