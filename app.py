    ...
    try:
        ...
        if platform == 'youtube':
            ...
            return jsonify({
                ...
                'url': url,
                'status': 'manual_only',
                'message': '⚠️ LinkedIn API restricted hai (requires Partner approval)',
                'manual_tips': [
                    'LinkedIn Analytics dashboard use karo (Creator mode enable karo)',
                    'Post pe click karo → "View Analytics" button',
                    'Profile pe jaao → Analytics → Content tab',
                ],
                'workaround': 'LinkedIn Creator Mode enable karo → Post Analytics manually dekh sakte ho',
                'get_creator_mode': 'linkedin.com → Profile → Resources → Creator mode'
            })
            ...
            return jsonify({
                ...
                'url': url,
                'status': 'unsupported',
                'message': '❌ Platform detect nahi hua. YouTube, Twitter/X, Instagram, Facebook, LinkedIn URLs supported hain.',
                'supported': ['youtube.com', 'youtu.be', 'twitter.com', 'x.com', 'instagram.com', 'facebook.com', 'linkedin.com']
            })
