...
from flask import Flask, request, jsonify, render_template, send_from_directory, redirect, url_for, Response, send_file
...
# ✅ PNG Routes (static folder se — PNG ke liye theek hai)
@app.route('/plot.png')
def plot_png():
...
# ✅ CSV — Memory se serve (Render pe kaam karega!)
