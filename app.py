...
def hf_status():
    """Check HuggingFace Space status — green/red dot"""
    try:
        import requests as _req
        hf_url = os.environ.get('HF_SPACE_URL', '').strip()
        if not hf_url:
