        ...
        if query:
            ...
            if join_on:
                if join_on not in df1.columns:
                    return jsonify({'error': f'Column "{join_on}" file 1 mein nahi hai!
File 1 columns: {list(df1.columns)[:10]}'}), 400
                if join_on not in df2.columns:
                    return jsonify({'error': f'Column "{join_on}" file 2 mein nahi hai!
File 2 columns: {list(df2.columns)[:10]}'}), 400
                ...
                if not common:
                    return jsonify({'error': f'Koi common column nahi!
File1: {list(df1.columns)[:5]}
File2: {list(df2.columns)[:5]}'}), 400
